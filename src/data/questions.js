export const QUESTIONS = {
  ...
  maths: [
    {
      id: 'm1',
      question: "Find the value of x in the equation: 2^(2x+1) - 5(2^x) + 2 = 0",
      options: ["x = 1 or x = -1", "x = 1 or x = 0", "x = 2 or x = 1", "x = -1 or x = 0"],
      correctAnswer: 0,
      explanation: "Let y = 2^x. The equation becomes 2y^2 - 5y + 2 = 0. Solving the quadratic gives y = 2 or y = 1/2. Thus 2^x = 2 (x=1) or 2^x = 2^-1 (x=-1)."
    },
    {
      id: 'm2',
      question: "Calculate the derivative of f(x) = ln(sin(x^2)).",
      options: ["2x * cot(x^2)", "2x * tan(x^2)", "cot(x^2) / 2x", "cos(x^2) / sin(x^2)"],
      correctAnswer: 0,
      explanation: "Using the chain rule: f'(x) = [1/sin(x^2)] * cos(x^2) * 2x = 2x * cot(x^2)."
    },
    {
      id: 'm3',
      question: "If log₁₀(x² - 3x + 6) = 1, find the possible values of x.",
      options: ["x = 4 or x = -1", "x = 2 or x = 3", "x = 5 or x = -2", "x = 1 or x = -4"],
      correctAnswer: 0,
      explanation: "x² - 3x + 6 = 10¹ => x² - 3x - 4 = 0 => (x-4)(x+1) = 0. So x = 4 or x = -1."
    },
    {
      id: 'm4',
      question: "Evaluate the integral of (3x² + 4x - 5) dx from 1 to 2.",
      options: ["8", "12", "10", "14"],
      correctAnswer: 0,
      explanation: "Integral = [x³ + 2x² - 5x] from 1 to 2 = (8 + 8 - 10) - (1 + 2 - 5) = 6 - (-2) = 8."
    },
    {
      id: 'm5',
      ...
      correctAnswer: 0,
      explanation: "P(Red 1st) = 5/8. P(Red 2nd | Red 1st) = 4/7. P(Both Red) = (5/8) * (4/7) = 20/56 = 5/14."
    },
    {
      id: 'm6',
      question: "Find the sum of the first 20 terms of an arithmetic progression whose first term is 5 and common difference is 3.",
      options: ["670", "700", "730", "640"],
      correctAnswer: 0,
      explanation: "S₂₀ = (n/2)[2a + (n-1)d] = (20/2)[2(5) + (19)(3)] = 10[10 + 57] = 670."
    },
    {
      id: 'm7',
      question: "Determine the coordinates of the center of the circle x² + y² - 6x + 8y + 9 = 0.",
      options: ["(3, -4)", "(-3, 4)", "(6, -8)", "(-6, 8)"],
      correctAnswer: 0,
      explanation: "Complete the squares: (x-3)² - 9 + (y+4)² - 16 + 9 = 0 => (x-3)² + (y+4)² = 16. Center is (3, -4)."
    },
    {
      id: 'm8',
      ...
      correctAnswer: 0,
      explanation: "cos²(θ) = 1 - sin²(θ) = 1 - 9/25 = 16/25. In the 2nd quadrant, cos is negative, so cos(θ) = -4/5."
    },
    {
      id: 'm9',
      question: "Solve for x: log₂(x+3) + log₂(x-3) = 4",
      options: ["x = 5", "x = 4", "x = 7", "x = 6"],
      correctAnswer: 0,
      explanation: "log₂((x+3)(x-3)) = 4 => x² - 9 = 2⁴ = 16 => x² = 25 => x = 5 (since x must be > 3)."
    },
    {
      id: 'm10',
      question: "The volume of a sphere is 36π cm³. Find its radius.",
      options: ["3 cm", "6 cm", "4 cm", "2 cm"],
      correctAnswer: 0,
      explanation: "V = (4/3)πr³ = 36π => r³ = (36 * 3) / 4 = 27 => r = 3 cm."
    },
    {
      id: 'm11',
      ...
      correctAnswer: 0,
      explanation: "(x² - 1) / (x - 1) = (x-1)(x+1) / (x-1) = x+1. As x -> 1, x+1 -> 2."
    },
    {
      id: 'm12',
      question: "In a triangle ABC, a=5, b=7, and angle C=60°. Find the length of side c using the Law of Cosines.",
      options: ["√39", "√74", "6", "√19"],
      correctAnswer: 0,
      explanation: "c² = a² + b² - 2ab cos(C) = 5² + 7² - 2(5)(7)cos(60°) = 25 + 49 - 70(0.5) = 74 - 35 = 39. So c = √39."
    },
    {
      id: 'm13',
      question: "Find the slope of the tangent line to the curve y = x³ - 2x + 1 at the point where x = 2.",
      options: ["10", "12", "6", "8"],
      correctAnswer: 0,
      explanation: "dy/dx = 3x² - 2. At x = 2, dy/dx = 3(2)² - 2 = 12 - 2 = 10."
    },
    {
      id: 'm14',
    ...
    {
      id: 'm15',
      question: "Find the sum of the infinite geometric series: 1 + 1/3 + 1/9 + ...",
      options: ["3/2", "2", "4/3", "Infinite"],
      correctAnswer: 0,
      explanation: "S = a / (1 - r) = 1 / (1 - 1/3) = 1 / (2/3) = 3/2."
    },
    {
      id: 'm16',
      ...
      options: ["-1", "1", "i", "-i"],
      correctAnswer: 0,
      explanation: "i¹ = i, i² = -1, i³ = -i, i⁴ = 1. i¹⁴ = (i⁴)³ * i² = 1³ * (-1) = -1."
    },
    {
      id: 'm17',
    ...
    },
    {
      ...
      options: ["x = 6 or x = -1", "x = 1 or x = -6", "x = 4 or x = 1", "x = 7 or x = -2"],
      correctAnswer: 0,
      explanation: "2x - 5 = 7 => 2x = 12 => x = 6. Or 2x - 5 = -7 => 2x = -2 => x = -1."
    },
    {
      id: 'm19',
      question: "Find the area of a triangle with vertices (1, 2), (4, 5), and (7, 1).",
      options: ["10.5", "12", "9", "15"],
      correctAnswer: 0,
      explanation: "Area = 0.5 * |x₁(y₂-y₃) + x₂(y₃-y₁) + x₃(y₁-y₂)| = 0.5 * |1(5-1) + 4(1-2) + 7(2-5)| = 0.5 * |4 - 4 - 21| = 0.5 * |-21| = 10.5."
    },
    {
      id: 'm20',
      question: "What is the 10th term of the sequence: 2, 6, 18, 54, ...?",
      options: ["39366", "13122", "118098", "4374"],
      correctAnswer: 0,
      explanation: "This is a geometric progression with a=2 and r=3. T₁₀ = ar⁹ = 2 * 3⁹ = 2 * 19683 = 39366."
    },
    {
      id: 'm21',
      question: "Find the number of ways to arrange the letters in the word 'MATHEMATICS'.",
      options: ["4,989,600", "39,916,800", "11,000,000", "5,040"],
      correctAnswer: 0,
      explanation: "Word has 11 letters: M(2), A(2), T(2), H(1), E(1), I(1), C(1), S(1). Total = 11! / (2! * 2! * 2!) = 39916800 / 8 = 4,989,600."
    },
    {
      id: 'm22',
      question: "If y = x² * e^x, find dy/dx.",
      options: ["x * e^x * (x + 2)", "x² * e^x + 2x", "2x * e^x", "e^x * (x² + 2)"],
      correctAnswer: 0,
      explanation: "Product rule: dy/dx = (x²)(e^x) + (2x)(e^x) = x * e^x * (x + 2)."
    },
    {
      id: 'm23',
      question: "Solve the inequality: x² - 5x + 6 < 0",
      options: ["2 < x < 3", "x < 2 or x > 3", "x < 6", "x > 1"],
      correctAnswer: 0,
      explanation: "(x-2)(x-3) < 0. The expression is negative between the roots x=2 and x=3."
    },
    {
      id: 'm24',
      question: "Find the value of cos(150°).",
    ...
    {
      id: 'm25',
      question: "The ratio of the areas of two similar triangles is 16:25. Find the ratio of their corresponding sides.",
      options: ["4:5", "2:3", "16:25", "256:625"],
      correctAnswer: 0,
      explanation: "Ratio of areas = (Ratio of sides)². So Ratio of sides = √(16:25) = 4:5."
    },
    {
      id: 'm26',
      question: "If 3x + 2y = 12 and x - y = 4, find the value of x.",
      options: ["4", "2", "3", "5"],
      correctAnswer: 0,
      explanation: "From the second equation, y = x - 4. Substitute into the first: 3x + 2(x - 4) = 12 => 5x - 8 = 12 => 5x = 20 => x = 4."
    },
    {
      id: 'm27',
      question: "Evaluate log₅(1/125).",
      options: ["-3", "3", "-2", "2"],
      correctAnswer: 0,
      explanation: "1/125 = 1 / 5³ = 5⁻³. So log₅(5⁻³) = -3."
    },
    {
      id: 'm28',
    ...
    },
    {
      ...
      options: ["2π / 3", "2π", "π / 3", "3π"],
      correctAnswer: 0,
      explanation: "The period of sin(kx) is 2π/k. Here k=3, so period = 2π/3."
    },
    {
      id: 'm30',
    ...
    {
      id: 'm31',
      question: "The length of a rectangle is 3 cm more than its width. If the perimeter is 26 cm, find the width.",
      options: ["5 cm", "8 cm", "6 cm", "4 cm"],
      correctAnswer: 0,
      explanation: "2(w + w + 3) = 26 => 2(2w + 3) = 26 => 4w + 6 = 26 => 4w = 20 => w = 5."
    },
    {
      id: 'm32',
    ...
    {
      id: 'm33',
      question: "Find the 2nd derivative of y = e^(2x).",
    ...
    {
      id: 'm34',
      question: "If a circle has an area of 49π, what is its circumference?",
    ...
    },
    {
      ...
      options: ["(5, 0)", "(0, -4)", "(-5, 0)", "(0, 4)"],
      correctAnswer: 0,
      explanation: "Set y = 0: 4x = 20 => x = 5. The intercept is (5, 0)."
    },
    {
      id: 'm36',
      ...
      correctAnswer: 0,
      explanation: "By mathematical definition, 0! = 1."
    },
    {
      id: 'm37',
      question: "In a right-angled triangle, if the hypotenuse is 13 cm and one side is 12 cm, find the third side.",
      options: ["5 cm", "1 cm", "7 cm", "8 cm"],
      correctAnswer: 0,
      explanation: "a² + 12² = 13² => a² + 144 = 169 => a² = 25 => a = 5."
    },
    {
      id: 'm38',
      question: "If the probability of an event happening is 0.7, what is the probability of it not happening?",
    ...
    {
      id: 'm39',
      question: "Evaluate 5C2 (the number of combinations of 5 items taken 2 at a time).",
      options: ["10", "20", "5", "15"],
      correctAnswer: 0,
      explanation: "5C2 = 5! / (2! * 3!) = (5 * 4) / 2 = 10."
    },
    {
      id: 'm40',
  ...
  physics: [
    {
      id: 'p1',
      question: "A car accelerates uniformly from rest to a velocity of 20 m/s in 5 seconds. What is the distance traveled?",
      options: ["50 m", "100 m", "25 m", "200 m"],
      correctAnswer: 0,
      explanation: "Using s = ut + 0.5at². a = (v-u)/t = 20/5 = 4 m/s². s = 0 + 0.5(4)(5²) = 2 * 25 = 50 m."
    },
    {
      id: 'p2',
      question: "What is the refractive index of a medium if the speed of light in it is 2.0 x 10⁸ m/s? (Speed of light in vacuum = 3.0 x 10⁸ m/s)",
      options: ["1.5", "0.67", "2.0", "1.33"],
      correctAnswer: 0,
      explanation: "n = c / v = (3.0 x 10⁸) / (2.0 x 10⁸) = 1.5."
    },
    {
      id: 'p3',
      question: "Calculate the force required to accelerate a 5 kg mass at 10 m/s².",
      options: ["50 N", "2 N", "15 N", "0.5 N"],
      correctAnswer: 0,
      explanation: "F = ma = 5 kg * 10 m/s² = 50 N."
    },
    {
      id: 'p4',
      question: "A 100 W light bulb is left on for 10 hours. How much energy is consumed in kilowatt-hours (kWh)?",
      options: ["1 kWh", "10 kWh", "100 kWh", "0.1 kWh"],
      correctAnswer: 0,
      explanation: "Energy (kWh) = Power (kW) * Time (h) = 0.1 kW * 10 h = 1 kWh."
    },
    {
      id: 'p5',
      question: "What is the equivalent resistance of two 10-ohm resistors connected in parallel?",
      options: ["5 ohms", "20 ohms", "10 ohms", "1 ohm"],
      correctAnswer: 0,
      explanation: "1/R_eq = 1/R1 + 1/R2 = 1/10 + 1/10 = 2/10. R_eq = 10/2 = 5 ohms."
    },
    {
      id: 'p6',
      question: "An object is placed 20 cm in front of a concave mirror with a focal length of 10 cm. Where is the image formed?",
      options: ["20 cm in front of the mirror", "10 cm in front of the mirror", "20 cm behind the mirror", "At infinity"],
      correctAnswer: 0,
      explanation: "Using 1/f = 1/u + 1/v: 1/10 = 1/20 + 1/v => 1/v = 1/10 - 1/20 = 1/20. v = 20 cm."
    },
    {
      id: 'p7',
      question: "Which of the following properties of a wave remains constant when it moves from one medium to another?",
      options: ["Frequency", "Wavelength", "Velocity", "Amplitude"],
      correctAnswer: 0,
      explanation: "The frequency of a wave is determined by the source and does not change with the medium."
    },
    {
      id: 'p8',
      question: "A hydraulic press has a small piston of area 0.01 m² and a large piston of area 0.1 m². If a force of 100 N is applied to the small piston, what is the force exerted by the large piston?",
      options: ["1000 N", "100 N", "10 N", "10000 N"],
      correctAnswer: 0,
      explanation: "P1 = P2 => F1/A1 = F2/A2 => 100/0.01 = F2/0.1 => F2 = 100 * 10 = 1000 N."
    },
    {
      id: 'p9',
      question: "What is the work done in lifting a 2 kg book to a height of 1.5 m? (g = 9.8 m/s²)",
      options: ["29.4 J", "3.0 J", "19.6 J", "14.7 J"],
      correctAnswer: 0,
      explanation: "Work = mgh = 2 * 9.8 * 1.5 = 29.4 J."
    },
    {
      id: 'p10',
      question: "According to the First Law of Thermodynamics, the change in internal energy of a system is equal to:",
      options: ["Heat added minus work done by the system", "Heat added plus work done by the system", "Work done minus heat added", "The total heat in the system"],
      correctAnswer: 0,
      explanation: "ΔU = Q - W, where Q is heat added and W is work done by the system."
    },
    {
      id: 'p11',
      question: "A simple pendulum has a period of 2 seconds. If its length is quadrupled, what will be its new period?",
      options: ["4 seconds", "1 second", "8 seconds", "2 seconds"],
      correctAnswer: 0,
      explanation: "T = 2π√(L/g). If L becomes 4L, T becomes √(4)T = 2T = 4 seconds."
    },
    {
      id: 'p12',
      question: "What is the centripetal force acting on a 1 kg object moving in a circle of radius 2 m at a speed of 4 m/s?",
      options: ["8 N", "16 N", "4 N", "2 N"],
      correctAnswer: 0,
      explanation: "F = mv²/r = (1 * 4²) / 2 = 16 / 2 = 8 N."
    },
    {
      id: 'p13',
    ...
    {
      id: 'p14',
      question: "A transformer has 100 turns in the primary and 500 turns in the secondary. If the primary voltage is 20 V, what is the secondary voltage?",
      options: ["100 V", "4 V", "50 V", "200 V"],
      correctAnswer: 0,
      explanation: "Vs/Vp = Ns/Np => Vs/20 = 500/100 = 5 => Vs = 100 V."
    },
    {
      id: 'p15',
      question: "The half-life of a radioactive substance is 10 days. How much of a 100 g sample remains after 30 days?",
      options: ["12.5 g", "25 g", "50 g", "33.3 g"],
      correctAnswer: 0,
      explanation: "30 days is 3 half-lives. Amount remaining = 100 * (1/2)³ = 100 / 8 = 12.5 g."
    },
    {
      id: 'p16',
      question: "In which of the following states of matter is the speed of sound generally the highest?",
      options: ["Solids", "Liquids", "Gases", "Vacuum"],
      correctAnswer: 0,
      explanation: "Sound travels faster in denser media with higher elasticity, so it is fastest in solids."
    },
    {
      id: 'p17',
      question: "A lens has a power of +5 diopters. What is its focal length?",
      options: ["0.2 m", "5 m", "0.5 m", "2 m"],
      correctAnswer: 0,
      explanation: "P = 1/f (in meters). f = 1/P = 1/5 = 0.2 m."
    },
    {
      id: 'p18',
      question: "Which law states that the current flowing through a conductor is directly proportional to the potential difference across it, provided temperature remains constant?",
      options: ["Ohm's Law", "Faraday's Law", "Lenz's Law", "Newton's Second Law"],
      correctAnswer: 0,
      explanation: "V = IR is the mathematical representation of Ohm's Law."
    },
    {
      id: 'p19',
      question: "What is the pressure at a depth of 10 m in water? (Density of water = 1000 kg/m³, g = 9.8 m/s²)",
      options: ["98,000 Pa", "10,000 Pa", "9,800 Pa", "100,000 Pa"],
      correctAnswer: 0,
      explanation: "Pressure = hρg = 10 * 1000 * 9.8 = 98,000 Pa (excluding atmospheric pressure)."
    },
    {
      id: 'p20',
      question: "An object of mass 10 kg is dropped from a height of 20 m. What is its kinetic energy just before it hits the ground? (g = 10 m/s²)",
      options: ["2000 J", "1000 J", "200 J", "4000 J"],
      correctAnswer: 0,
      explanation: "Potential Energy at top = Kinetic Energy at bottom. PE = mgh = 10 * 10 * 20 = 2000 J."
    },
    {
      id: 'p21',
      question: "The escape velocity of a planet depends on:",
      options: ["Mass and radius of the planet", "Mass of the object", "Radius of the object", "Temperature of the planet"],
      correctAnswer: 0,
      explanation: "v_e = √(2GM/R), where M is planet mass and R is planet radius."
    },
    {
      id: 'p22',
      question: "Which of the following is a vector quantity?",
      options: ["Displacement", "Distance", "Speed", "Mass"],
      correctAnswer: 0,
      explanation: "Displacement has both magnitude and direction, unlike distance, speed, or mass."
    },
    {
      id: 'p23',
      question: "What is the frequency of a wave with a wavelength of 0.5 m and a speed of 340 m/s?",
      options: ["680 Hz", "170 Hz", "340 Hz", "0.0015 Hz"],
      correctAnswer: 0,
      explanation: "f = v / λ = 340 / 0.5 = 680 Hz."
    },
    {
      id: 'p24',
      question: "A wire has a resistance of 4 ohms. If its length is doubled and its cross-sectional area is halved, what is the new resistance?",
      options: ["16 ohms", "8 ohms", "4 ohms", "2 ohms"],
      correctAnswer: 0,
      explanation: "R = ρL/A. New R = ρ(2L)/(A/2) = 4 * (ρL/A) = 4 * 4 = 16 ohms."
    },
    {
      id: 'p25',
      question: "Which phenomenon explains the splitting of white light into its component colors by a prism?",
      options: ["Dispersion", "Refraction", "Reflection", "Diffraction"],
      correctAnswer: 0,
      explanation: "Dispersion occurs because different colors of light travel at different speeds in the glass, causing them to bend by different amounts."
    },
    {
      id: 'p26',
      question: "The latent heat of fusion of ice is 334 J/g. How much heat is required to melt 50 g of ice at 0°C?",
      options: ["16,700 J", "6.68 J", "3340 J", "50,000 J"],
      correctAnswer: 0,
      explanation: "Q = mL = 50 g * 334 J/g = 16,700 J."
    },
    {
      id: 'p27',
      ...
      correctAnswer: 0,
      explanation: "Magnetic flux density is measured in Teslas (T)."
    },
    {
      id: 'p28',
      question: "A body of mass 2 kg moving at 4 m/s collides elastically with a stationary body of the same mass. What are their velocities after the collision?",
      options: ["0 m/s and 4 m/s", "2 m/s and 2 m/s", "4 m/s and 0 m/s", "4 m/s and 4 m/s"],
      correctAnswer: 0,
      explanation: "In an elastic collision of equal masses where one is stationary, they exchange velocities."
    },
    {
      id: 'p29',
      question: "The photoelectric effect demonstrates the:",
      options: ["Particle nature of light", "Wave nature of light", "Dual nature of matter", "Refraction of light"],
      correctAnswer: 0,
      explanation: "The photoelectric effect shows that light can be thought of as discrete packets of energy (photons)."
    },
    {
      id: 'p30',
      question: "Which force is responsible for keeping the planets in orbit around the Sun?",
      options: ["Gravitational force", "Electromagnetic force", "Nuclear force", "Centrifugal force"],
      correctAnswer: 0,
      explanation: "Gravity provides the necessary centripetal force for planetary motion."
    },
    {
      id: 'p31',
      question: "A convex lens forms a virtual, upright, and magnified image when the object is placed:",
      options: ["Between the focus and the optical center", "At the focus", "Between F and 2F", "Beyond 2F"],
      correctAnswer: 0,
      explanation: "This is how a magnifying glass works."
    },
    {
      id: 'p32',
      question: "What is the momentum of a 0.5 kg ball moving at 10 m/s?",
      options: ["5 kg·m/s", "20 kg·m/s", "0.05 kg·m/s", "50 kg·m/s"],
      correctAnswer: 0,
      explanation: "p = mv = 0.5 kg * 10 m/s = 5 kg·m/s."
    },
    {
      id: 'p33',
      question: "The absolute zero temperature is approximately:",
      options: ["-273.15 °C", "0 °C", "100 °C", "-100 °C"],
      correctAnswer: 0,
      explanation: "Absolute zero is 0 Kelvin, which corresponds to -273.15 Celsius."
    },
    {
      id: 'p34',
      ...
      correctAnswer: 0,
      explanation: "A voltmeter is connected in parallel to measure voltage (potential difference)."
    },
    {
      id: 'p35',
      question: "The property of a body to resist any change in its state of rest or uniform motion is called:",
      options: ["Inertia", "Momentum", "Force", "Friction"],
      correctAnswer: 0,
      explanation: "Inertia is directly proportional to the mass of the body."
    },
    {
      id: 'p36',
      question: "What is the primary fuel used in nuclear fission reactors?",
      options: ["Uranium-235", "Hydrogen", "Carbon", "Helium"],
      correctAnswer: 0,
      explanation: "U-235 is a fissile isotope used in most commercial nuclear reactors."
    },
    {
      id: 'p37',
      question: "In a longitudinal wave, the particles of the medium vibrate:",
      options: ["Parallel to the direction of wave travel", "Perpendicular to the direction of wave travel", "In circles", "They do not vibrate"],
      correctAnswer: 0,
      explanation: "Sound waves in air are a common example of longitudinal waves."
    },
    {
      id: 'p38',
      question: "What is the weight of a 60 kg person on the Moon? (g_moon = 1.6 m/s²)",
      options: ["96 N", "600 N", "60 N", "37.5 N"],
      correctAnswer: 0,
      explanation: "Weight = mg = 60 * 1.6 = 96 N."
    },
    {
      id: 'p39',
      question: "The 'pitch' of a sound depends primarily on its:",
      options: ["Frequency", "Amplitude", "Wavelength", "Speed"],
      correctAnswer: 0,
      explanation: "High frequency corresponds to high pitch, while low frequency corresponds to low pitch."
    },
    {
      id: 'p40',
      ...
      correctAnswer: 0,
      explanation: "Convex mirrors provide a wider field of view and always form upright images."
    }
  ],
  chemistry: [
    {
