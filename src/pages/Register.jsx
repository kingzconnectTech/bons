    ...
    <div className="flex min-h-screen bg-slate-50 flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 premium-gradient items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-white max-w-md text-center">
          ...
          >
            <UserPlus className="w-12 h-12 text-brand-mint" />
          </motion.div>
          <motion.h1 
          ...
          >
            Create an account to start practicing and excel in your exams with deep analytics.
          </motion.p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-20 py-12 lg:py-20">
        ...
        >
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-4xl font-black text-brand-black mb-2 uppercase tracking-tight">Create Account</h2>
            <p className="text-slate-600 font-bold">Start your journey to excellence</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
            ...
            <div>
              <label className="block text-sm font-black text-slate-800 mb-2 ml-1 uppercase tracking-wider">Confirm Password</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <Lock className="h-5 w-5 text-slate-500 group-focus-within:text-brand-mint transition-colors" />
                </div>
          ...
          <p className="mt-8 sm:mt-10 text-center text-sm font-bold text-slate-500">
            ...
            <Link to="/login" className="text-brand-mint hover:text-brand-deep underline underline-offset-4 decoration-2 transition-colors">
              Sign In
            </Link>
          </p>
        </motion.div>
